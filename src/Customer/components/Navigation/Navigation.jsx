  ...
  categories: [
    {
      ...
      featured: [
        ...
        },
        {
          name: 'Basic Tees',
          href: '#',
          imageSrc: 'https://i.pinimg.com/originals/cb/31/87/cb318789eecdbe77c9375cf78ba0f25e.jpg',
          imageAlt: 'Close up of Basic Tee fall bundle with off-white, ochre, olive, and black tees.',
        },
      ],
      sections: [
...
export default function Navigation() {
  ...
  /*{it is for open and close big dropdown}*/
                        ...
                        >
                          {section.items.map((item) => (
                            <li key={item.name} className="flow-root">
                              <NavLink to={`/${category.id}/${section.id}/${item.name}`} className="-m-2 block p-2 text-gray-500">
                                {item.name}
                              </NavLink>
                            </li>
                          ))}
            ...
            <div className="flex h-16 items-center">
                                    ...
                                    >
                                      {section.items.map((item) => (
                                        <li key={item.name} className="flex">
                                          <NavLink to={`${category.id}/${section.id}/${item.name}`} className="hover:text-gray-800">
                                            {item.name}
                                          </NavLink>
                                        </li>
                                      ))}
              ...
              <div className="ml-auto flex items-center justify-center p-1">

                {
                  token ?
                    <>
                        {authUserData?.role==="ADMIN"?<NavLink to="/admin" className="Admin-dashboard">Admin Dashboard</NavLink>:""}
                        ...
                        <Avatar
                          ...
                          onClick={handleClick}
                        >
                          {authUserData && authUserData.firstName[0]}
                        </Avatar>
                        <Menu
                        ...
                        >
                          ...
                          <MenuItem onClick={handleClose}>
                            <NavLink to="/account/order">My Orders</NavLink>
                          </MenuItem>
                          <NavLink to="/userLogout">
                      ...
                      <div className="ml-4 flow-root lg:ml-6 ">
                        <NavLink to='/cart' className="group -m-2 flex items-center p-2">
                          <Badge badgeContent={Cart?.userCart?.cartItems?.length} color="warning">
                          <ShoppingBagIcon
                            aria-hidden="true"
